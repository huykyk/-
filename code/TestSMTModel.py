...
class TestSMTModel(object):
	...
	def testGenerateAndPrint(self):
		self.model.generateAndPrint(u'听钟投宿入孤烟')
		self.model.generateAndPrint(u'佳人忆山水')
		self.model.generateAndPrint(u'朝朝奉御临池上')
		self.model.generateAndPrint(u'幽人听达曙')
		self.model.generateAndPrint(u'降集翻翔凤')
		self.model.generateAndPrint(u'圣主此时思共理')
		self.model.generateAndPrint(u'化城若化出')
		self.model.generateAndPrint(u'樱桃未绽梅花老')
		self.model.generateAndPrint(u'万里亲朋散')
		self.model.generateAndPrint(u'五马踟蹰在路岐')
